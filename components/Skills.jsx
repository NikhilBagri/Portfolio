...
import Figma from '../public/assets/skills/figm.png'
import Mongo from '../public/assets/skills/mongo.png'
import Boot from '../public/assets/skills/boot.png'
import Git from '../public/assets/skills/git.png'
import Word from '../public/assets/skills/word.png'
import VS from '../public/assets/skills/vs.png'
      ...
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-5 gap-8'>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={Boot} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>Bootstrap</h3>
              </div>
